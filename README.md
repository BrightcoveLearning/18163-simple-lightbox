...
# 18163-simple-lightbox
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-simple-lightbox.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>simple-lightbox.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>simple-lightbox.css</strong>.</td>
    </tr>
  </tbody>
</table>
